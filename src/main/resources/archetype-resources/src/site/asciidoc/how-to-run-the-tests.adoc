...
As entry point the Landing Page of the ${ets-title-short} is expected.

=== 1. Integrated development environment (IDE)

Use a Java IDE such as Eclipse, NetBeans, or IntelliJ. Clone the repository and build the project.

Set the main class to run: `${package}.TestNGController`
...
`java -jar ets-${ets-code}-${version}-aio.jar [-o|--outputDir $TMPDIR] [test-run-props.xml]`
